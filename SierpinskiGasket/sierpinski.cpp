...
void drawShape(float vertex1[], float vertex2[], float vertex3[], int current_depth)
{
	...
	drawShape(next_vertex1, vertex1, next_vertex2, current_depth + 1);
	drawShape(next_vertex1, vertex2, next_vertex3, current_depth + 1);
	drawShape(next_vertex3, vertex3, next_vertex2, current_depth + 1);
}

void Display()
{
	/*float vertex1[3] = { 1.0 * scale, -0.571 * scale, 0.0 };
	float vertex2[3] = { -1.0 * scale, -0.571 * scale, 0.0 };
	float vertex3[3] = { 0.0, 1.181 * scale, 0.0 };*/

	float vertex1[3] = { 2.0 * scale, 0.0, 0.0 };
	float vertex2[3] = { 0.0, 0.0, 0.0 };
	float vertex3[3] = { 1.0 * scale, 1.732 * scale, 0.0 };
